...
app.post('/connexion', (req, res) => {
  // CORRIGE : on force chaque champ a etre une chaine de caracteres.
  // Un operateur ($ne, ...) glisse dans le corps devient alors une chaine inerte,
  // qui ne correspond a aucun utilisateur. Les connexions normales marchent toujours.

  const filtre = { nom: String(req.body.nom == null ? "" : req.body.nom), mdp: String(req.body.mdp == null ? "" : req.body.mdp) };
